        ...
        "columns": [
            ...
            { "data": "total", "visible": false },
            {
                ...
                "render": function (data, type, row) {
                    var formattedString = (parseFloat(data).toFixed(2).toString());
                    return formattedString;
                }
            }
        ],
        "order": [[1, 'desc']], // order by total
        "language": {
...
function LoadAllReportWiseList(yearID, monthID) {
    ...
    $.ajax({
        type: "GET",
        url: window.base_url + "VendorReport/GetCustomerOverallDetails?Year=" + yearID + "&Month=" + monthID,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            //console.log(data);
